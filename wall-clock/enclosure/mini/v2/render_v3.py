...
NEW_B = trimesh.load(csg.part('mini-round-clock-base.stl')); NEW_B.merge_vertices()
OLD_D = csg.to_trimesh(load_sams_diffuser())
NEW_D = trimesh.load(csg.part('mini-round-clock-diffuser.stl')); NEW_D.merge_vertices()
